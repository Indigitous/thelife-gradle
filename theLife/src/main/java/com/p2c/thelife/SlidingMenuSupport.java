...
//		if (m_activity instanceof AppCompatActivity) {
    ((AppCompatActivity) m_activity).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
//		} else if (m_activity instanceof FragmentActivity) {
//			((FragmentActivity)m_activity).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
//		}
  }
  ...
  public void onOpen() {
    // nasty code because of the interaction of third party libs
//		if (m_activity instanceof AppCompatActivity) {
    ((AppCompatActivity) m_activity).getSupportActionBar().setDisplayHomeAsUpEnabled(false);
//		} else if (m_activity instanceof FragmentActivity) {
//			((FragmentActivity)m_activity).getSupportActionBar().setDisplayHomeAsUpEnabled(false);
//		}
  }
