 ...
 *
 */
public abstract class SetupActivityAbstract extends AppCompatActivity implements DSRefreshedListener, GCMSupport.Listener {
	...
	public void notifyGCMRegistrationAvailable(String indicator, String errorString) {
		if (m_progressDialog != null) {
			...
			Intent intent = new Intent(m_isNewUser ? "com.p2c.thelife.NewUserHelp" : "com.p2c.thelife.Initial");
